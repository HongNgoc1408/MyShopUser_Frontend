      ...
      >
        <div class="grid grid-cols-5 gap-5 my-5">
          ...
          <div className="col-span-2">
            ...
            <div className="flex">
              <p className="mr-1 my-auto p-auto text-red-600 text-2xl">
                189.000{" "}
              </p>
              <p className="mx-1 my-auto p-auto text-red-600 text-xl">VND</p>
              <p className="mx-1 my-auto p-auto text-base">Còn lại: 33 | </p>
              <p className="mx-1 my-auto p-auto text-base">Đã bán: 97</p>
            </div>
            <div>
              <p className="text-lg">Màu sắc: Vàng</p>
            </div>
